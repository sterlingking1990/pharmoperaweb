            ...
            <div className="bg-gradient-to-br from-green-50 to-blue-50 rounded-xl p-6 mb-4">
              ...
              <div className="bg-white rounded-lg p-4 mb-3 shadow-sm">
                <p className="text-sm text-gray-700">
                  Melinda, whose phone number is 2348012345890, will be treated with artemether–lumefantrine for 3 days, taking one tablet twice daily. After completing the medication, a follow-up will be conducted to assess her condition.
                </p>
              </div>
